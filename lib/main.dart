...
import 'package:crudcatatan/db/database_instance.dart';
import 'package:crudcatatan/models/transaksi_model.dart';
import 'package:crudcatatan/screens/create_screen.dart';
import 'package:crudcatatan/screens/update_screen.dart';
                ...
                FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        if (snapshot.hasData) {
                          return Text(
                              "Catatan Diary. ${snapshot.data.toString()}");
                        } else {
                          return Text("");
                        }
                      }
                ...
                FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        if (snapshot.hasData) {
                          return Text(
                              "Catatan Bisnis. ${snapshot.data.toString()}");
                        } else {
                          return Text("");
                        }
                      }
